  ...
  <div className="page-container" style={{ overflow: "auto" }}>
    <title>VCK</title>
      ...
      <div className="hero-section" >
        <img src="/image/college-banner.png" alt="Vivekanand College Campus" className="hero-banner-image"/>
...
{/* IMAGE------------------------------------------------------------------------------------------------------------------------------------ */}
      ...
      <div className="image-gallery">
        <img src="/image/students-studying.jpeg" alt="Students of library" />
        <img src="/image/campus-life.jpg" alt="campus ground" />
      </div>
